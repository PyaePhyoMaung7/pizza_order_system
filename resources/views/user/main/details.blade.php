                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 object-fit-cover" style="height: 60vh" src="{{asset('storage/'.$pizza->image)}}" alt="Image">
                        </div>
                ...
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="text" id="pizzaCount" class="form-control border-0 text-center" value="1" max="20">
                    ...
                    @foreach ($pizzaList as $pizza)
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden" >
                                <img class="img-fluid w-100 object-fit-cover " style="height: 200px;" src="{{asset('storage/'.$pizza->image)}}" alt="">
                                <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                                    <a class="btn btn-outline-dark btn-square" href="{{route('user#pizzaDetails',$pizza->id)}}"><i class="fa fa-circle-info"></i></a>
                                </div>
                            </div>
