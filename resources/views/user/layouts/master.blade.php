        ...
        <div class="row px-xl-5 align-items-center">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <span class="h3 text-uppercase text-warning bg-dark px-2">My Shop</span>
                </a>
            </div>
            <div class="col-lg-9">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item py-3" href="{{route('user#accountChangePage')}}"><i
                                            class="fa-solid fa-user me-2"></i>Account</a></li>
                                <li><a class="dropdown-item py-3" href="{{ route('user#changePasswordPage') }}"><i
                                ...
                                <li>
                                    <span class="dropdown-item py-3">
                                        <form action="{{ route('logout') }}" method="post">
                                            ...
                                            <button type='submit' class="btn btn-dark shadow-sm rounded-3 w-100">
