...
@section('title', 'Admin Details Edit Page')
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if (Auth::user()->image == null)
                                                @if (Auth::user()->gender == 'male')
                                                    <img src="{{ asset('image/default_male.jpg') }}" class="shadow-sm w-100" alt="">
                                                @else
                                                    <img src="{{ asset('image/default_female.webp') }}" class="shadow-sm w-100" alt="">
                                                @endif
                                            @else
                                            ...
                                            @endif
                                            <div class="mt-3">
                                                <input type="file" name="image" class="form-control @error('image') is-invalid mb-1 @enderror" id="">
                                                @error('image')
